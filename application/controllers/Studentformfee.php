...
class Studentformfee extends Admin_Controller
{
    ...
    //     $this->session->set_userdata('sub_menu', 'studentotherfee/index');
    //     $data['title']     = 'student fees';
    //     $class             = $this->class_model->get();
    //     $data['classlist'] = $class;
    //     $this->load->view('layout/header', $data);
    //     $this->load->view('studentfee/studentotherfeeSearch', $data);
    ...
    //             $student_due_fee              = $this->studentfeemaster_model->getStudentOtherFees($student['student_session_id']);
    ...
    public function addfee($id,$fees_type)
    {
        // echo $id;
        // echo $fees_type;
        ...
        $student         = $this->enquiry_model->getenquiry_list1($id);
        $data['student'] = $student;

        $student_due_fee = $this->studentfeemaster_model->getStudentformFees_byType($id,$fees_type);
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('studentfee/studentAddformfee', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    //     $student_due_fee = $this->studentfeemaster_model->getStudentOtherFees($id);
