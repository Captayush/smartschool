...
class Studenttransportfee extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_menu', 'studenttransportfee/index');
        $data['title']     = 'student fees';
        $class             = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/header', $data);
        $this->load->view('studentfee/studenttransportfeeSearch', $data);
    ...
    public function addfee($id)
    {
        ...
        $student_due_fee = $this->studentfeemaster_model->getStudentTransportFees($id);
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('studentfee/studentAddtransportfee', $data);
        $this->load->view('layout/footer', $data);
    }
